...
> 가입 방식·요금·상업적 이용 정책은 확정 전이라 "문의 안내"로 처리합니다(docs/open-questions.md 참고).
...
음성 모델과 성우 음성에 대한 권리는 회사에 있습니다. 생성한 음성의 상업적 이용 범위(예: 광고·유튜브 등)는 별도 정책 또는 계약에 따르며, 상업적 사용이나 라이선스가 필요하면 business@softstorycorp.com으로 문의해 주세요.
Rights to the voice models and voice-actor audio belong to the company. Commercial use of generated audio (e.g., ads, YouTube) follows a separate policy or agreement; for commercial use or licensing, please contact business@softstorycorp.com.
